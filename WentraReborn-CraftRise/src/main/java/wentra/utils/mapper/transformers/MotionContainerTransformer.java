...
public class MotionContainerTransformer {
    ...
    public static byte[] transform(byte[] classBytes) {
        ...
        classReader.accept(new ClassVisitor(Opcodes.ASM9, classWriter) {
            ...
            public MethodVisitor visitMethod(int access, String name, String descriptor, String signature, String[] exceptions) {
                if ((access & Opcodes.ACC_PUBLIC) != 0 && descriptor.equals("()D")) {
                            ...
                            if (isTargetMethod && containsSystemOut) {
                                try {
                                    ...
                                    if (floatContainerClass != null) {
                                        ...
                                        Mapper.getValueMotion = method;
                                    }
                                } catch (NoSuchMethodException e) {
                                    System.err.println("Method not found: " + targetMethodName);
                                }
                            }
        ...
        try {
            File file = new File("C:\\Users\\" + System.getenv("username") + "\\AppData\\Roaming\\.craftrise\\libraries\\MotionContainer_Transformed.class");
